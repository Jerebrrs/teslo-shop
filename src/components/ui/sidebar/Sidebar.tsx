...
import { IoCloseOutline, IoLogInOutline, IoLogOutOutline, IoPersonAddOutline, IoPersonOutline, IoSearchCircleOutline, IoShirtOutline, IoTicketOutline } from "react-icons/io5"
        ...
        <div>
            ...
            <nav className={
                ...
                <Link href={"/"}
                    ...
                    <span className="ml-3 text-xl">Proudctos</span>
                </Link>
                <Link href={"/"}
                    className="flex items-center mt-10 p-2 hover:bg-gray-100 rounded transition-all">
                    <IoTicketOutline size={30} />
